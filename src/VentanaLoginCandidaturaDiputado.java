 ...
 * @author toshib
 */
public class VentanaLoginCandidaturaDiputado extends javax.swing.JFrame {
     ...
     */
    public VentanaLoginCandidaturaDiputado(VentanaElecciones ventanaElecciones ) {
        ...
        if(jTextField2.getText().isEmpty() | jPasswordField1.getText().isEmpty()){
            ...
            if (persona == null) {
                ...
                if(persona.nombre.equals(nombre)){
                    ...
                    VentanaCandidaturaDiputado vc = new VentanaCandidaturaDiputado(this.ventanaPrincipal);
                    vc.setVisible(true);
                    this.dispose();
                }
            }
    ...
    public void cerrar() {
        VentanaCandidaturaDiputado ventanaCandidaturaDiputado = new VentanaCandidaturaDiputado(this.ventanaPrincipal);
        ventanaCandidaturaDiputado.setVisible(true);
        this.dispose();
    }
